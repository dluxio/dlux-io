...
function dexview(pair, type) {
    ...
    if (User.opts.type === 'Buy') {
        ...
        document.getElementById('listButton').class = 'btn-outline-success btn-outline-success'
    } else {
        ...
        document.getElementById('listButton').class = 'btn-outline-success btn-outline-danger'
    }
