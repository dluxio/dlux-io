...
dmx.Formatters("global", {
    ...
    dmx.Formatters("number", {
        ...
        toBetterDate: function(t) {
            return new Date(t).toISOString().substr(0,16);
        }
    }),
    (function() {
        function e(t) {
        ...
        dmx.Formatters("string", {
            ...
            search: function(n, t, r) {
                return String(t)
                    .split(/\s+/)[r ? "every" : "some"](function(t) {
			...
			getSetDetailsColorsTxt : function(s, i, c){
                ...
                document.getElementById(`${s}${i}`).style.-webkit-background-clip = 'text';
                document.getElementById(`${s}${i}`).style.color = 'transparent';
                })
            },
