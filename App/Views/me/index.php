...
<?php 
	if(isset($author)){
		...
		echo "<dmx-api-datasource id=\"dluxGetAccount\" is=\"dmx-fetch\" url=\"https://token.dlux.io/api/condenser_api/get_accounts\" mx-param:tag=\"'".$_COOKIE['user']."'\"></dmx-api-datasource>";
        }
		else{
		...
		echo "<dmx-api-datasource id=\"dluxGetAccount\" is=\"dmx-fetch\" url=\"https://token.dlux.io/api/condenser_api/get_accounts/\" dmx-param:tag=\"'robotolux'\"></dmx-api-datasource>";
        }
;?>	
<?php 
   $path = $_SERVER['DOCUMENT_ROOT'];
