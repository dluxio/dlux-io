           ...
           <div class="card text-white bg-dark mt-2 mb-3">
             ...
             <div class="card-footer">
               ...
               <div class="d-flex align-items-center my-2">
                 <div><a data-toggle="collapse" dmx-bind:data-target="{{&quot;#&quot;}}vote{{post_id}}"><i class="fas fa-heart fa-fw mr-1" style="color: {{active_votes.hasVoted(sessionStorage('user'))}}"></i>{{active_votes.hasVoted(sessionStorage('user'))}}</a>{{active_votes.countUpVotes()}} <i class="fas fa-comment fa-fw ml-2 mr-1"></i>{{children}}</div>
