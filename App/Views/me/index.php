        ...
        <div role="tabpanel" class="tab-pane fade show active" id="dlux" aria-labelledby="dluxtab">
          ...
          <div class="container">
			...
			<span>{{larynxdexapi.data.behind}} BBH</span> 
              ...
              <div class="clearfix" id="larynxclaimdiv" dmx-show="larynxtoken.data.drop.last_claim.parseInt(16) != frmDate.value && larynxtoken.data.drop.available.amount.toNumber() > 0">
                <hr class="my-4 bg-light">
                <div class="float-left">
                  <h4>Claim LARYNX</h4>
