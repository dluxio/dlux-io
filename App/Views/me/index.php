					    ...
					    <div class="input-group mb-3">
					      <div class="input-group-prepend">
					        <div class="input-group-text">
					          <input id="govcheck" class="bg-dark border-dark text-info" type="checkbox" aria-label="Claim GOV not PWR">
				            </div>
				          </div>
					      <input type="text" class="bg-dark border-dark text-info form-control" placeholder="Claim GOV not PWR">
				        </div>
                      </div>
                  </div>
                </div>
