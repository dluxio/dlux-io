...
<p class="lead">
          <a class="btn btn-lg btn-outline-primary m-3" href="/dlux-io/App/Views/apps/" role="button">Explore<i class="fab fa-wpexplorer ml-2"></i></a>
	
	<a class="btn btn-lg btn-outline-secondary" href="/dlux-io/App/Views/new/" role="button">Create<i class="fas fa-plus-circle ml-2"></i></a>
       </p>

    </div>
         <div class="col-xl-6 order-first order-md-last"><img src="/dlux-io/public/img/dlux-sdk.png" alt="dlux logo" class="img-fluid"></div>
</div>
    </div> 
    </div>
    ...
    <div class="container-fluid text-white bg-dark">
	  <div class="row">
		  <div class="col-xl-4">
			  ...
			  <p><img src="/dlux-io/public/img/smart-img.png" class="img-fluid rounded" alt="smart"></p>
	    ...
	    <div class="col-xl-4">
	    	...
	    	<p><img src="/dlux-io/public/img/secure-img.png" class="img-fluid rounded" alt="secure"></p>
	    ...
	    <div class="col-xl-4">
	    	...
	    	<p><img src="/dlux-io/public/img/compatible-img.png" class="img-fluid rounded" alt="compatible"></p>
