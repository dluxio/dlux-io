    ...
    <div class="container text-white">
      ...
      <div id="tradeForms">
        <div class="row">
          ...
          <div class="mt-3 col-md-6">
            <h4>Sell DLUX</h4>
            <form class="form-horizontal needs-validation" dmx-bind:action="javascript:sellDEX({{sellQuantity.value.toNumber()}},null,{{sellTotal.value.toNumber()}},{{sellHours.value.toNumber()}})">
                ...
                <div class="form-row">
                  ...
                  <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-outline-warning active">
                      ...
                      LIMIT </label>
                    <label class="btn btn-outline-warning">
                      <input name="sellType" type="radio" id="sell-market" dmx-on:click="form.buyTotal.setValue(0);form.buyHours.setValue(0)">
                      MARKET </label>
                  </div>
                </div>
              </div>
