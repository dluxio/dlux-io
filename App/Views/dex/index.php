...
function totals (){
      ...
      if(HIVES.length ){
        ...
        for(var i = 0; i < HIVEH.length; i++){
          console.log(Date.now() , Date.UTC(HIVEH[i].getElementsByTagName('td')[2].innerText + ':00.000Z') , 86400000)
          try{
            if (Date.now() - Date.UTC(HIVEH[i].getElementsByTagName('td')[2].innerText + ':00.000Z') < 86400000)
