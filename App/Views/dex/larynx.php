        ...
        <div class="d-flex flex-column justify-content-between align-items-center px-3 py-1" style="background-color: black;">
          <div class="d-flex align-itmes-center justify-content-between w-100">
            ...
            <div class="d-flex align-items-center text-white-50">
              <div id="userdlux" class="mx-4"><a href="/me#spk"><span class="text-warning">{{bartoken}} {{TOKEN}}</span></a></div>
              <div id="userdpwr" class="mx-4" v-if="accountapi.poweredUp > 0"><a href="/me#spk"><span class="text-primary">{{barpow}} {{TOKEN}}P</span></a></div>
              <div id="userdgov" class="mx-4" v-if="accountapi.gov > 0"><a href="/me#spk"><span class="text-info">{{bargov}} {{TOKEN}}G</span></a></div>
              <div id="userhive" class="mx-4"><a href="/me#hive"><span class="text-danger">{{barhive}}</span></a></div>
              <div id="userhbd" class="mx-4"><a href="/me#hive"><span class="text-success">{{barhbd}}</span></a></div>
            </div>
          </div>
                  ...
                  <table role="table" aria-busy="false" aria-colcount="3" class="table table-dark bg-darker text-white-50 table-striped table-hover table-borderless mb-0" id="larynxnodes">
                    <thead role="rowgroup" class="">
                      <tr role="row" class="">
                        ...
                        <th role="columnheader" class="" aria-colindex="4"> <div class="d-flex justify-content-end">
          ...
          <div class="col-lg-9" v-if="buyhive.checked">
            <div class="row">
              ...
              <div class="mt-2 col">
                ...
                <i class="fas fa-dollar-sign mx-1"></i>{{toFixed(volume.hive * hiveprice.hive.usd, 2)}} </div>
            </div>
          </div>
          <div class="col-lg-9" v-if="buyhbd.checked">
            <div class="row">
              ...
              <div class="mt-2 col">
                ...
                <i class="fas fa-dollar-sign mx-1"></i>{{toFixed(volume.hbd * hbdprice.hive_dollar.usd, 2)}} </div>
            </div>
          </div>
        </div>
        <!-- maret chart -->
                  ...
                  <div class="form-row">
                    ...
                    <div tabindex="-1" role="group" class="col">
					  ...
					  <div class="small" v-if="buyhive.checked">BALANCE<br><a href="#/" @click="setValue('buyHiveTotal',balance < maxhbuy? balance : maxhbuy)" >{{barhive}}</a>
					   ...
					   <div class="small" v-if="buyhbd.checked">BALANCE<br><a href="#/" @click="setValue('buyHBDTotal',hbd_balance < maxhbuy? hbd_balance : maxhbuy)" >{{barhbd}}</a>
					  </div>
                  </div>
                </div>
