...
<main role="main" class="flex-shrink-0 text-white">
  <div class="container-fluid px-0 ">
	...
	<input id="timenow" dmx-bind:value="{{nodes.data.node.eval('getCookie('lapi')')}}">1{{nodes.data.node.eval('getCookie('lapi')')}}1 2{{openordersapi.data.node.eval('getCookie(`lapi`)')}}2
