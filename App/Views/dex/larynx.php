        ...
        <div class="col-4">
          <div class="jumbotron p-3 bg-dark" v-if="buyhive.checked">
            <div id="dluxhivequote">
              <h2 class="lead my-0"><b>{{TOKEN}}: ${{toFixed((dexapi.markets ? dexapi.markets.hive.tick : 0) * hiveprice.hive.usd, 6)}}</b><b>Supply: {{toFixed(stats.tokenSupply/1000, 3)}}</b> <b>Market Cap: {{marketCap}}</b> Dex Fee: {{stats.dex_fee}}% | ~10 Minute Clearing Time</h2>
            </div>
          </div>
