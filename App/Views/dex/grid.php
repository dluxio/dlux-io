...
<main role="main" class="flex-shrink-0">
  <section class="content">
    ...
    <div class="row"> 
      <!-- WIDGETS -->
      <div class="col-xl-3">
        <div class="jumbotron bg-darker mx-2 my-4">
          <div class="d-flex justify-content-between align-items-center row"> 
            <!-- data filters -->
            <div class="d-flex flex-column col-md-6 col-xl-12">
            ...
            <!-- data stats -->
            <div class="d-flex card bg-none p-0 flex-column col-md-6 col-xl-12">
                ...
                <div class="d-flex flex-column flex-fill rounded-lg p-3 my-1 border border-danger" >
                  ...
                  <div class="d-flex flex-row flex-fill mt-1">
                    ...
                    <div class="d-flex ml-auto flex-column">
                      <p class="ml-auto my-0 text-white-50 font-weight-bolder" style="font-size: 30px;">{{value.hivenai.nai()}}</p>
    ...
    <!-- MAIN VIEW -->
    <div class="jumbotron bg-dark my-4 p-2 text-center col-xl-6 col-md-12">
        ...
        <div class="tab-content" id="orderbookview1tabs"> 
              ...
              <div dmx-repeat:repeat4="orderbookview1.data" dmx-on:click="iteratedluxsellorders.select($index); orderbookview1Detail.select(txid)">
				...
				<div class="btn card bg-darker p-0 ml-0 my-1" 
                  ...
                  <div class="card-header text-right" 
					   ...
					   dmx-class:text-white-50="rate > maxprice.value">
					  <small>RATE: {{rate}}</small> </div>
          ...
          <div class="tab-pane fade" id="item" role="tabpanel" aria-labelledby="table-tab">
            <div class="jumbotron bg-darker my-4"> 
              ...
              <!-- data iterator view -->
              <div id="orderbookview1Iterate" class="d-flex justify-content-between align-items-center">
                <button class="btn btn-primary" dmx-on:click="iteratedluxsellorders.prev()">&larr;</button>
                <dmx-data-iterator id="iteratedluxsellorders" dmx-bind:data="orderbookview1.data" loop="true"><a href="#" dmx-on:click="orderbookview1Detail.select(value.txid)">
