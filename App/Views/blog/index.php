...
<main role="main" class="flex-shrink-0 ">
  <div class="container bg-dark text-white pb-2 mb-3">
    <div class="d-flex align-items-center">
      <div> <a dmx-bind:href="/@{{dluxGetContent.data.result.author}}"><img dmx-bind:src="https://images.hive.blog/u/{{dluxGetContent.data.result.author}}/avatar" alt="" class="rounded-circle bg-light img-fluid mr-2 cover author-img"/></a> </div>
      <div>
    ...
    <div class="container" id="comments" is="dmx-repeat" dmx-bind:repeat="dluxGetReplies.data.result">
      <div class="d-flex align-items-center">
        <div> <a dmx-bind:href="/@{{author}}"><img dmx-bind:src="https://images.hive.blog/u/{{author}}/avatar" alt="" class="rounded-circle bg-light img-fluid mr-2 cover author-img"/></a> </div>
        <div>
