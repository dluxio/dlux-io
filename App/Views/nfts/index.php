  ...
  <div dmx-repeat:repeatauctiontoken1="auctionsview.data">
    <div class="m-2 bg-dark card text-white">
      ...
      <div class="card-footer text-center d-flex justify-content-between align-items-center"> <span>{{bids}} Bids</span>
        ...
        <button href="#auctionsModal" class="btn btn-secondary btn-lg" style="min-width:100px" data-toggle="modal" dmx-show="(by == userCookie.value)" dmx-on:click="auctions_iterator.select($index);auctions_detail.select(uid)" role="button">Active</button>
      </div>
    </div>
  </div>
</div>
